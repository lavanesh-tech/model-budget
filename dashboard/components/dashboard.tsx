...
async function load(name: string) { const r = await fetch(`/api/admin/${name}`); if (!r.ok) throw new Error("Dashboard data is unavailable"); return r.json(); }
